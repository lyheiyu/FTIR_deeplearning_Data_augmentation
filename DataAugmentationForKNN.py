...
if __name__ == '__main__':
    ...
    for ki in range(2,20):
        ...
        #     nums=[1,2]
            ...
            print(m)
        print(scoreTotal / m)
        metricstotal.append(scoreTotal/m)
    metricstotal=pd.DataFrame(metricstotal)
    metricstotal.to_csv('metricstotal.csv '+str(ki))
        # maxnumber.append(sum(scoreTotal / m) )
        #
    cmTotal = cmTotal / m
    plt.clf()
    utils.plot_confusion_matrix(cmTotal, PN, 'Original_KNN')
