...
from FTIR_fit_least_square import generatedataBySperateLSforEach,\
    ...
    generatedataBySperateLSforEach9
if __name__ == '__main__':
    ...
    for seedNum in range(20):
        ...
        #     #     # noiseforeahc = []
        #     #     # for eachj in range(len(intensityforRandomLoop[i])):
        #     #     #
        #     #     #     noiseforeahc.append(intensityforRandomLoop[i][eachj])
        #     #
        #     #
        #     #     intensityplusnoise.append(data2D[i]+random.randint(-50, 50)*0.1)
        #     # intensityplusnoise=np.array(intensityplusnoise)
        #     # _, coefs_ = emsc(
        #     #     intensityplusnoise, waveLength,reference=None,
        #     #     order=2,
        #     #     return_coefs=True)
        ...
        #     # for 8 sa method
        #     #data2D = random.sample(list(data2D), 800)
        ...
        #model = MLPClassifier(solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(244, 258), random_state=0)
