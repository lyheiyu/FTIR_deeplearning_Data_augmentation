...
if __name__ == '__main__':
    ...
    polymerName, waveLength, intensity, polymerID = utils.parseData3rd('dataset/216_2018_1156_MOESM2_ESM modified2.csv')
    from FTIR_dataGenerateByConcentratedNet import TwoDimensionalAugmentation
    ...
    cmTotal = cmTotal / m
    plt.clf()
    #utils.plot_confusion_matrix(cmTotal, PN, 'Original dataset KNN')
